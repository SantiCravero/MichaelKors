        ...
        <div className="min-h-full flex">
          <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div className="mx-auto w-full max-w-sm lg:w-96">
              <div className='pt-5'>
                <h2 className="mt-6 text-3xl font-extrabold text-gray-900">Iniciar sesión en tu cuenta</h2>
              ...
              <div className="mt-8">
                <div>
                  <div>
                    <p className="text-sm font-medium text-gray-700">Iniciar sesión con</p>
                ...
                <div className="mt-6">
                  <form onSubmit={handleSingIn} action="#" method="POST" className="space-y-6">
                    <div>
          ...
          <div className="hidden lg:block relative w-0 flex-1">
            <img
              ...
              src="/assets/clock-g8892adb80_1280.jpg"
              alt=""
            />
          </div>
        </div>
