        ...
        <div className="container px-24 py-8 mx-auto">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4 h-24 items-center self-center">
                ...
                <button className="btn-cssbuttons flex m-auto">
                    ...
                    <ul>
                        <li>
                            <a href="https://twitter.com/" target="_black"><svg height="18" width="18" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1024 1024" className="icon">
                        ...
                        <li>
                            <a href="https://codepen.io/" target="_black"><svg height="18" width="18" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1024 1024" className="icon">
                        ...
                        <li>
                            <a href="https://github.com/SantiCravero" target="_black"><svg height="18" width="18" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1024 1024" className="icon">
