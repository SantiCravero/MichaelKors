      ...
      <div className="mx-auto max-w-7xl py-24 px-4 sm:px-6 sm:py-16 lg:px-8">
        ...
        <div className="container px-24 py-8 mx-auto">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <nav className="list-none mb-10">
                <li>
                    <Link to="/categoria/hombres" className="cursor-pointer text-white hover:text-yellow-600 transition-all duration-200">Relojes para Hombres</Link>
                </li>
                <li>
                    <Link to="/categoria/mujeres" className="cursor-pointer text-white hover:text-yellow-600 transition-all duration-200">Relojes para Mujeres</Link>
                </li>
                <li>
                    <Link to="/categoria/oro" className="cursor-pointer text-white hover:text-yellow-600 transition-all duration-200">Relojes de Oro</Link>
                </li>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4 h-24 items-center self-center">
                <Link to="/">
                    <img onClick={toHome} src="/assets/MichaelKors.png" className='hover:scale-105 ease-in-out duration-300 block' alt="" />
                </Link>

                <button className="btn-cssbuttons flex m-auto">
                    <span>Redes</span>
                    <span>
                    ...
                    <ul>
                        <li>
                            <Link href="https://twitter.com/" target="_black"><svg height="18" width="18" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1024 1024" className="icon">
                        ...
                        <li>
                            <Link href="https://codepen.io/" target="_black"><svg height="18" width="18" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1024 1024" className="icon">
